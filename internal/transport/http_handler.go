...
func dispatchMethod(ctx *gin.Context, methodName string, params interface{}) (interface{}, *domain.RPCError) {
	...
	case "eth_uninstallFilter":
		params := rpcParams.(*domain.EthUninstallFilterParams)
		return filterService.UninstallFilter(params.FilterID)
	case "eth_newPendingTransactionFilter":
		return filterService.NewPendingTransactionFilter()
	case "eth_getFilterLogs":
		params := rpcParams.(*domain.EthGetFilterLogsParams)
		return filterService.GetFilterLogs(params.FilterID)
	case "eth_getFilterChanges":
		params := rpcParams.(*domain.EthGetFilterChangesParams)
		return filterService.GetFilterChanges(params.FilterID)
	default:
